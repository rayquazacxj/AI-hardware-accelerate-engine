...
read_file -format verilog {/users/student/mr108/hshuang19/uds/UDS.v}
analyze -library WORK -format verilog {/users/student/mr108/hshuang19/uds/UDS.v}
elaborate UDS -architecture verilog -library WORK
